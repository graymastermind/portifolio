const StageEF = () => {				
	...
	//- Camera
		...
		if(appObj.mainWidth<appObj.mainHeight){
			...
			for(let i = 0; i<10; i++){
				appMc["ability_bar_"+i].scale.set(0.7)
				appMc["ability_bar_"+i].x = 105-appObj.canvasWidth*0.5/appMc.mcUI.scale.y;
		...
		if(counter>7){
			objTemp = appMc["level2CharacterIcon_"+selectedAvatar];
			objTemp.a0 +=5;
