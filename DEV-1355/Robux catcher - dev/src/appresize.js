...
const AppResize = (e) =>{
	...
	if(appObj.mainWidth<appObj.mainHeight){	
		...
		appMc.won.y=300-appObj.canvasHeight*0.5/appMc.mcUI.scale.y;

		appMc.points.scale.set(1.4);
		appMc.points.y=400-appObj.canvasHeight*0.5/appMc.mcUI.scale.y;

		appMc.mcDigitF.scale.set(0.7);
		appMc.mcDigitF.y=400-appObj.canvasHeight*0.5/appMc.mcUI.scale.y;
		...
		// Final card texts
		appMc.won.scale.set(1.4);
		appMc.won.y=200-appObj.canvasHeight*0.5/appMc.mcUI.scale.y;

		appMc.points.scale.set(1.4);
		appMc.points.y=300-appObj.canvasHeight*0.5/appMc.mcUI.scale.y;

		appMc.mcDigitF.scale.set(0.7);
		appMc.mcDigitF.y=300-appObj.canvasHeight*0.5/appMc.mcUI.scale.y;
