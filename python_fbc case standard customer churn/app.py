...
st.set_page_config(page_title="FBC CROSS-SELLING", page_icon="🏦")
...
with header:
    st.header("FBC Optimal selection of customers for cross-selling of financial services products")
